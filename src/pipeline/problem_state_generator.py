...
class ProblemStateGenerator:
    ...
    def smoke_test(self, instance_problem_state_code: str, solution_problem_state_code: str, observation_problem_state_code: str) -> str:
        ...
        try:
            # Load instance problem state extractor and run
            instance_problem_state_extractor = load_function(instance_problem_state_code, function_name="get_instance_problem_state")
            instance_problem_state = instance_problem_state_extractor(env.instance_data)
        ...
        try:
            # Load solution problem state extractor and run
            solution_problem_state_extractor = load_function(solution_problem_state_code, function_name="get_solution_problem_state")
            solution_problem_state = solution_problem_state_extractor(env.instance_data, env.current_solution)
        ...
        try:
            # Load observation problem state extractor and run
            observation_problem_state_extractor = load_function(observation_problem_state_code, function_name="get_observation_problem_state")
            observation_problem_state = observation_problem_state_extractor(solution_problem_state)
